...
def enigma_dec_enc(Reflector: int, LRotor: int, MRotor: int, RRotor: int, PlugBoard: list, key_set: str,
            ...
            match choose_encryption_method:
                ...
                case 5:
                    EncryptedFile.write(str(index_key.index(
                        enigma_dec_enc(enigma_key[0], enigma_key[1], enigma_key[2], enigma_key[3], enigma_key[4],
                                       enigma_key[5], enigma_key[6],
...
def reading_decrypting(choose_encryption_method: int, src_s: str, src_f: str, key: int, enigma_key=None):
    time.sleep(3)
    ...
    while (byte := EncrypredFile.readline()):
        ...
        match choose_encryption_method:
            ...
            case 5:
                byte = enigma_dec_enc(enigma_key[0], enigma_key[1], enigma_key[2], enigma_key[3], enigma_key[4],
                                      enigma_key[5], enigma_key[6], byte)
            case default:
                pass
        wynik = wynik + byte
        if len(wynik) == 2:
...
def handle_input_enc(choose_encryption_method: int, inp, key, enigma_key=None):
    match choose_encryption_method:
        ...
        case 5:
            return enigma_dec_enc(enigma_key[0], enigma_key[1], enigma_key[2], enigma_key[3], enigma_key[4],
                                  enigma_key[5], enigma_key[6], inp)
        case default:
            pass
